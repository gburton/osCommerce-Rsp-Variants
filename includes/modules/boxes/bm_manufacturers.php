...
// Display a list
          ...
          while ($manufacturers = tep_db_fetch_array($manufacturers_query)) {
            ...
            $manufacturers_list .= '<li><a href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers=' . $manufacturers['manufacturers_id']) . '">' . $manufacturers_name . '</a></li>';
          }
...
// Display a drop-down
          ...
          $data = tep_draw_form('manufacturers', tep_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get') .
                     tep_draw_pull_down_menu('manufacturers', $manufacturers_array, (isset($_GET['manufacturers_id']) ? $_GET['manufacturers_id'] : ''), 'onchange="this.form.submit();" size="' . MAX_MANUFACTURERS_LIST . '" style="width: 100%"') . tep_hide_session_id() .
                     '</form>';
        }
