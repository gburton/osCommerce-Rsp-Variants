	...
	<?php
		...
		<?php
			...
			while ($listing = tep_db_fetch_array($listing_query)) {
				...
				// manufacturer
				if (($lc_show_manu == true) && ($osC_Product->getManufacturerID() !=  0)) $extra_list_contents .= '<dt>' . TABLE_HEADING_MANUFACTURER . '</dt><dd><a href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers=' . $osC_Product->getManufacturerID()) . '">' . $osC_Product->getManufacturer() . '</a></dd>';
				// model
