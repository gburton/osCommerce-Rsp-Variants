...
// Output a selection field - alias function for tep_draw_checkbox_field() and tep_draw_radio_field()
  function tep_draw_selection_field($name, $type, $value = '', $checked = false, $compare = '', $class = '') {
    global $HTTP_GET_VARS, $HTTP_POST_VARS;

    $selection = '<input type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
    
	if (tep_not_null($class)) $selection .= ' class="' . tep_output_string($class) . '"';
...
// Output a form checkbox field
  function tep_draw_checkbox_field($name, $value = '', $checked = false, $compare = '', $class = '') {
    return tep_draw_selection_field($name, 'checkbox', $value, $checked, $compare, $class);
  }

////
// Output a form radio field
  function tep_draw_radio_field($name, $value = '', $checked = false, $compare = '', $class = '') {
    return tep_draw_selection_field($name, 'radio', $value, $checked, $compare, $class);
  }
...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $params2 = null) {
    $button_counter = uniqid();
    ...
    }elseif(($params['type'] == 'button') && isset($params2)){
      $button .= '<button id="tdb' . $button_counter . '" '.$params2.' type="' . tep_output_string($params['type']) . '"';	
	}else {
