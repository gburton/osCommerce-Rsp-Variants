...
<link href="<?php echo tep_catalog_href_link('ext/tag-it/jquery.tagit.css', '', 'SSL'); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo tep_catalog_href_link('ext/tag-it/tagit.ui-zendesk.css', '', 'SSL'); ?>" rel="stylesheet" type="text/css">
<script type="text/javascript" charset="utf-8" src="<?php echo tep_catalog_href_link('ext/tag-it/tag-it.js', '', 'SSL'); ?>"></script>
