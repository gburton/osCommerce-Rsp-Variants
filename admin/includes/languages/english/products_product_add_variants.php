...
define('TEXT_DEFAULT_COMBO', 'Set default?');

define('TEXT_NO_OPTIONS_SELECTED_TITLE', 'Missing value\'s');
define('TEXT_NO_OPTIONS_SELECTED', 'One or more variants have no value\'s assigned, <br> please make the required changes.');
